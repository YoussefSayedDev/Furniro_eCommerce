      ...
      <div className="group relative cursor-pointer overflow-hidden rounded-md">
        ...
        <div className="absolute bottom-0 left-0 right-0 z-20 flex h-0 flex-col items-center justify-center bg-[#3a3a3ab6] transition-all duration-500 group-hover:h-full">
          <button
            ...
            className="hidden h-[48px] w-[200px] bg-white font-poppins text-base font-semibold text-primary transition-colors duration-300 hover:bg-gray-50 group-hover:block"
          >
            Add to cart
          </button>
          ...
          <Link
            href={`/shop/${id}`}
            className="mt-10 hidden bg-white px-5 py-2 font-poppins text-base font-semibold text-primary transition-colors duration-200 hover:bg-gray-50 group-hover:block"
          >
            Show Details
          </Link>
        </div>
